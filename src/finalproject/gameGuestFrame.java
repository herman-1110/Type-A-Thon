...
public class gameGuestFrame extends JFrame implements ActionListener, KeyListener{
    ...
    JButton timer1, timer2, timer3, timer4, timedMode, wordMode, quoteMode, word1, word2, word3, word4, restartButton, nextButton, exit, signIn;
    ...
    public gameGuestFrame(){
        ...
        signIn = new JButton();
        signIn.setBounds(1250, 5, 60, 25);
        signIn.addActionListener(this);
        signIn.setText("Sign In");
        signIn.setFocusable(false);
        signIn.setFont(new Font("Banana Grotesk", Font.BOLD, 15));
        ...
        this.setTitle("Type-A-Thon (Guest mode)");
        this.add(timerLabel);
