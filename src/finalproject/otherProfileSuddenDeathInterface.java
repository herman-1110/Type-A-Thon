...
public class otherProfileSuddenDeathInterface {
    DefaultTableModel list;
    JTable listTable;
    JScrollPane listScroll;
    
    otherProfileSuddenDeathInterface(String username){
        ...
        try {
            Map<String, String> ranking = database.sort("suddenDeath", username);
            int i = 1;
